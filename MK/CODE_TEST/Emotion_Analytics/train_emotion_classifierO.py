...
class FactorDetector:
    ...
    def detect_emotion_factor(self, image):
        ...
        emotion = os.path.dirname(image)  # get the name of the folder as emotion
        ...
        while shape:
            ...
            img_cropped = image[target_face.top() - 50:target_face.bottom() + 80,
