...
class Photo:
    ...
    def retrieve_photo(self, dict_condition=None):
        ...
        try:
            ...
            print(e)
            print("Please check your type again.")
            return []
    ...
    def _db_update_photo(self, dict_info):
        ...
        with self.conn.cursor() as cursor:
            ...
            photo_id, session_id, saved_path = None, None, None
            ...
            for i in list(dict_info):
                if i is 'photo_id':
                    ...
                    print(f"Invalid key \'{i}\'. Please check your key again.")
                    return False

            # All attribute is needed.
...
if __name__ == '__main__':
    ...
    # pt.retrieve_photo({"start_date": '20190101'})


    # print(pt.retrieve_photo({"session_id": 1, "end_date": '20180227'}))
    # print(pt.retrieve_photo({"start_date": datetime.now()}))

    # print(pt.retrieve_photo({"session_id": 1}))

    # pt.update_photo({"photo_id":1, "session_id":1, "saved_path":'/test'})
    # pt.update_photo({"photo_id": 1, "session_id": 1, "saved_path": '/test'})
