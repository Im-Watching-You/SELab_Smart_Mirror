...
class AgingDiagnosis(threading.Thread):
    def __init__(self,  q, img):
        ...
        path_wrinkle_model = './models/aging_factor/age_wrinkle_model.pkl'
        m = self.open_model(path_wrinkle_model)
        self.set_model(m)
    ...
    # Formula for Computing Wrinkle Density
    ...
    # Formula for Computing Wrinkle Depth
    ...
    # Formula for Computing Average Skin Variance
    ...
    def extract_features(self, face_image):
        ...
        try:
            ...
            # Check for absence of None and Send Result
    ...
    # Getting result for Main Controller
    def get_result(self):
        return self.result
